      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100">
        <div className="container mx-auto px-6 h-20 flex items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8 mr-8">
            <Link href="/" className="text-gray-600 hover:text-[#262262]">Inicio</Link>
          ...
          <a href="https://wa.me/50689354555" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center space-x-2 text-[#262262] font-semibold hover:bg-gray-50 px-3 py-2 rounded-lg transition-colors">
        ...
        {open && (
          <div className="md:hidden border-t border-gray-100 px-6 pb-4">
            <Link href="/" className="block py-2 text-gray-700 hover:text-[#262262]" onClick={() => setOpen(false)}>Inicio</Link>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  ...
                  <a href="tel:+50640825234" className="hover:text-[#262262] transition-colors flex items-center gap-2 mt-2">
                    <Phone className="w-3 h-3" /> +(506) 4082-5234
                  </a>
                </li>
                <li>
